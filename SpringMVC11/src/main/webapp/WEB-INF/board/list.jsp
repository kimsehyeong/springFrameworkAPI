...
<body>
  ...
  <div class="card">
    <div class="card-header">
		  ...
		  <div class="container">
		    <h1>SPRINGBOOT_Project_By_KimSehyoneg</h1>
		    <p>Why do we put a # in the href attribute of the link?
Since we do not have any page to link it to, and we do not want to get a "404" message, we put # as the link in our examples. It should be a real URL to a specific page.</p>
		  </div>
		</div>
    </div>
    <div class="card-body">
    ...
    <div class="card-footer">김세형@springBoot_Test</div>
  </div>
